...
public class SwerveDriveOdometry extends CommandBase {
  ...
  public SwerveDriveOdometry(Pose2d m_targetPos) {
    ...
    targetTurnDegrees = RobotContainer.m_swerve.gyroAngle().getDegrees();
  ...
  public void execute() {
    ...
    if(Math.round(pos.getX()) != Math.round(targetXPos)){
    ...
    if(Math.round(pos.getY()) != Math.round(targetYPos)){
